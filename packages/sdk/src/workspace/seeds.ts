...
const ATTRIBUTES: AttributeSeed[] = [
  ...
  { object_slug: "communication_messages", attribute_slug: "body_preview", title: "Body preview", attribute_type: "text", is_multivalued: false, is_unique: false },
  ...
  { object_slug: "communication_messages", attribute_slug: "body_html_sanitized", title: "Sanitized HTML body", attribute_type: "text", is_multivalued: false, is_unique: false },
  { object_slug: "communication_messages", attribute_slug: "body_render_json", title: "Body render JSON", attribute_type: "json", is_multivalued: false, is_unique: false },
  { object_slug: "communication_messages", attribute_slug: "attachments_json", title: "Attachments JSON", attribute_type: "json", is_multivalued: false, is_unique: false },
